...
namespace CELL
{
    ...
    */
    ...
    public:
		...
		tmat3x3<T>&  translate(value_type x,value_type y)
		{
			this->value[0] = col_type(1, 0, 0);
            this->value[1] = col_type(0, 1, 0);
            this->value[2] = col_type(T(x), T(y), 1);
			return *this;
		}

		tmat3x3<T>& scale(value_type x,value_type y)
		{
		    this->value[0] = col_type(x, 0, 0);
            this->value[1] = col_type(0, y, 0);
            this->value[2] = col_type(0, 0, 1);
			return *this;
		}

		tmat3x3<T>& rotate(value_type angle)
		{
			T a = DEG2RAD(angle);
            T c = cos(a);
            T s = sin(a);
			this->value[0] = col_type(c, s, 0);
            this->value[1] = col_type(-s,c, 0);
            this->value[2] = col_type(0, 0, 1);
			return *this;
		}
    ...
    public:
        tmat4x4<T>  inverse() const
        {
			...
			/****************************************New Method Start***********************************************/
			value_type Coef00 = this->value[2][2] * this->value[3][3] - this->value[3][2] * this->value[2][3];
			value_type Coef02 = this->value[1][2] * this->value[3][3] - this->value[3][2] * this->value[1][3];
			value_type Coef03 = this->value[1][2] * this->value[2][3] - this->value[2][2] * this->value[1][3];

			value_type Coef04 = this->value[2][1] * this->value[3][3] - this->value[3][1] * this->value[2][3];
			value_type Coef06 = this->value[1][1] * this->value[3][3] - this->value[3][1] * this->value[1][3];
			value_type Coef07 = this->value[1][1] * this->value[2][3] - this->value[2][1] * this->value[1][3];

			value_type Coef08 = this->value[2][1] * this->value[3][2] - this->value[3][1] * this->value[2][2];
			value_type Coef10 = this->value[1][1] * this->value[3][2] - this->value[3][1] * this->value[1][2];
			value_type Coef11 = this->value[1][1] * this->value[2][2] - this->value[2][1] * this->value[1][2];

			value_type Coef12 = this->value[2][0] * this->value[3][3] - this->value[3][0] * this->value[2][3];
			value_type Coef14 = this->value[1][0] * this->value[3][3] - this->value[3][0] * this->value[1][3];
			value_type Coef15 = this->value[1][0] * this->value[2][3] - this->value[2][0] * this->value[1][3];

			value_type Coef16 = this->value[2][0] * this->value[3][2] - this->value[3][0] * this->value[2][2];
			value_type Coef18 = this->value[1][0] * this->value[3][2] - this->value[3][0] * this->value[1][2];
			value_type Coef19 = this->value[1][0] * this->value[2][2] - this->value[2][0] * this->value[1][2];

			value_type Coef20 = this->value[2][0] * this->value[3][1] - this->value[3][0] * this->value[2][1];
			value_type Coef22 = this->value[1][0] * this->value[3][1] - this->value[3][0] * this->value[1][1];
			value_type Coef23 = this->value[1][0] * this->value[2][1] - this->value[2][0] * this->value[1][1];

			row_type Fac0(Coef00, Coef00, Coef02, Coef03);
			row_type Fac1(Coef04, Coef04, Coef06, Coef07);
			row_type Fac2(Coef08, Coef08, Coef10, Coef11);
			row_type Fac3(Coef12, Coef12, Coef14, Coef15);
			row_type Fac4(Coef16, Coef16, Coef18, Coef19);
			row_type Fac5(Coef20, Coef20, Coef22, Coef23);

			row_type Vec0(this->value[1][0], this->value[0][0], this->value[0][0], this->value[0][0]);
			row_type Vec1(this->value[1][1], this->value[0][1], this->value[0][1], this->value[0][1]);
			row_type Vec2(this->value[1][2], this->value[0][2], this->value[0][2], this->value[0][2]);
			row_type Vec3(this->value[1][3], this->value[0][3], this->value[0][3], this->value[0][3]);

			row_type Inv0(Vec1 * Fac0 - Vec2 * Fac1 + Vec3 * Fac2);
			row_type Inv1(Vec0 * Fac0 - Vec2 * Fac3 + Vec3 * Fac4);
			row_type Inv2(Vec0 * Fac1 - Vec1 * Fac3 + Vec3 * Fac5);
			row_type Inv3(Vec0 * Fac2 - Vec1 * Fac4 + Vec2 * Fac5);

			row_type SignA(+1, -1, +1, -1);
			row_type SignB(-1, +1, -1, +1);
			type Inverse(Inv0 * SignA, Inv1 * SignB, Inv2 * SignA, Inv3 * SignB);

			row_type Row0(Inverse[0][0], Inverse[1][0], Inverse[2][0], Inverse[3][0]);

			row_type Dot0(this->value[0] * Row0);
