...
void String::RemoveSection(int nBeg, int nEnd)
{
	//rewrite when define assert.
	assert(nBeg >= 0 && nBeg < GetSize() && nEnd >= 0 && nEnd < GetSize());
	nBeg = std::min(nBeg, nEnd);
	int nSize = std::abs(nEnd - nBeg) + 1;
...
String String::CutSection(int nBeg, int nEnd) const
{
	//rewrite when define assert
	assert(nBeg >= 0 && nBeg < GetSize() && nEnd >= 0 && nEnd < GetSize());
	return CutMid(std::min(nBeg, nEnd), std::abs(nEnd - nBeg));
}
...
int16_t String::ToInt16(int fromBase) const
{
	return 0;
}

uint16_t String::ToUInt16(int fromBase) const
{
	return 0;
}

int32_t String::ToInt32(int fromBase) const
{
	return 0;
}

uint32_t String::ToUInt32(int fromBase) const
{
	return 0;
}

int64_t String::ToInt64(int fromBase) const
{
	return 0;
}

uint64_t String::ToUInt64(int fromBase) const
{
	return 0;
}

float String::ToSingle(int fromBase) const
{
	return 0.0f;
}

double String::ToDouble(int fromBase) const
{
	return 0.0;
}
...
String String::FromUtf16(const uint16_t *unicode, int nBeg, int nSize)
{
	return String((Char *)unicode, nBeg, nSize);
}

String String::FromUtf32(const uint32_t *ucs4, int nBeg, int nSize)
{
	//
	assert(0);
	return "";
...
String String::FromInt16(int16_t n, int toBase)
{
	return "";
}

String String::FromUInt16(uint16_t n, int toBase)
{
	return "";
}

String String::FromInt32(int32_t n, int toBase)
{
	return "";
}

String String::FromUInt32(uint32_t n, int toBase)
{
	return "";
}

String String::FromInt64(int64_t n, int toBase)
{
	return "";
}

String String::FromUInt64(uint64_t n, int toBase)
{
	return "";
}

String String::FromSingle(float f, int toBase)
{
	return "";
}

String String::FromDouble(double d, int toBase)
{
	return "";
}
