...
class NB_API AsciiEncoding : public Encoding
{
public:
	AsciiEncoding();
...
class NB_API Utf8Encoding : public Encoding
{
public:
	Utf8Encoding();
...
class NB_API Utf32Encoding : public Encoding
{
public:
public:
	Utf32Encoding();
...
class NB_API GbkEncoding : public Encoding
{
public:
	GbkEncoding();
