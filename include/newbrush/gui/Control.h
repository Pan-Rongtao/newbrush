...
public:
	...
	static DependencyPropertyPtr BackgroundProperty();					//背景的依赖属性(std::shared_ptr<Brush>)
	static DependencyPropertyPtr BorderBrushProperty();					//边框的依赖属性(std::shared_ptr<Brush>)
	...
	static DependencyPropertyPtr ForegroundProperty();					//字体前景色的依赖属性(std::shared_ptr<Brush>)
	...
	static DependencyPropertyPtr TemplateProperty();					//模板的依赖属性(std::shared_ptr<ControlTemplate>)
