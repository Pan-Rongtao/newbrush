...
class Encoding;
class NB_API String : public core::RefObject
{
...
//////////////////////////////////////
	...
	//转换为整数，frombase表示源进制
	int16_t ToInt16(int fromBase) const;
	uint16_t ToUInt16(int fromBase) const;
	int32_t ToInt32(int fromBase) const;
	uint32_t ToUInt32(int fromBase) const;
	int64_t ToInt64(int fromBase) const;
	uint64_t ToUInt64(int fromBase) const;
	float ToSingle(int fromBase) const;
	double ToDouble(int fromBase) const;
...
public:
	...
	static String FromUtf16(const uint16_t *unicode, int nBeg = 0, int nSize = -1);

	static String FromUtf32(const uint32_t *ucs4, int nBeg = 0, int nSize = -1);

	static String FromInt16(int16_t n, int toBase);
	static String FromUInt16(uint16_t n, int toBase);
	static String FromInt32(int32_t n, int toBase);
	static String FromUInt32(uint32_t n, int toBase);
	static String FromInt64(int64_t n, int toBase);
	static String FromUInt64(uint64_t n, int toBase);
	static String FromSingle(float f, int toBase);
	static String FromDouble(double d, int toBase);
...
NB_API DataSerial & operator << (DataSerial &serial, const nb::core::String &str);
NB_API DataSerial & operator >> (DataSerial &serial, nb::core::String &str);
