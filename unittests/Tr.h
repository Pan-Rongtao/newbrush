...
static int g_trLan = 0;
inline void setLanguage(int lan)	{ assert(lan < TR_LANGUAGE_COUNT); g_trLan = lan; }
inline const char *get(int id)		{ assert(id < TR_ID_MAX); return g_trStrMap[id][g_trLan]; }
#define	TR(id)						(get(id))
