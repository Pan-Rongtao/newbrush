...
SelectorView::SelectorView()
{
	...
	m_btnBackToHome->setBkgndPress(ImageBrush::createWitchTextureFrameName("modelDIY", "close_96_p.png"));
	...
	m_btnEdit->setBkgndPress(ImageBrush::createWitchTextureFrameName("modelDIY", "editor_96_p.png"));
	...
	m_btnDIYMode->setBkgndCheck(ImageBrush::createWitchTextureFrameName("modelDIY", "figure_choose_voice_image_female_p.png"));
	...
	m_btnXiMode->setBkgndCheck(ImageBrush::createWitchTextureFrameName("modelDIY", "figure_choose_xiaov_p.png"));
