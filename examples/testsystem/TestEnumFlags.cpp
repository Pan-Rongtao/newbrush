...
void TestEnumFlags::Test()
{
	...
	mf.AddFlags(Flag_0x00000001);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000002);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000004);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000008);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000010);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000020);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000040);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000080);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000100);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000200);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000400);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00000800);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00001000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00002000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00004000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00008000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00010000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00020000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00040000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00080000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00100000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00200000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00400000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x00800000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x01000000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x02000000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x04000000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x08000000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x10000000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x20000000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x40000000);
	printf("mf=%u\n", (int)mf);
	mf.AddFlags(Flag_0x80000000);
	printf("mf=%u\n", (int)mf);
