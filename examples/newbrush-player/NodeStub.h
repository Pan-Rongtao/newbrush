...
class NodeStub : public NodeRpc::Service, public StubBase
{
	...
	Status SetProperty(ServerContext* context, const SetPropertyRequest* request, CommonReply* response);

	var stringValueToVar(type t, const std::string &stringValue);
};