...
#include "../../../Include/Gui/PointAnimation.h"
#include "../../../Include/Gui/Grid.h"
#include "../../../Include/Gui/SolidColorBrush.h"

using namespace nb::Gui;

PointAnimationTestPage::PointAnimationTestPage(void)
{
	m_timerPosAnimation = new Timer();
	m_timerPosAnimation->Start(1000*4);
	m_timerPosAnimation->TimeoutEvent.Add(this, &PointAnimationTestPage::OnTimerOut);
...
void PointAnimationTestPage::OnTimerOut(nb::System::Timer::TimeoutParam &param)
{
	//m_rect->TestY() = 0;
	m_storyboard.Begin();
}
